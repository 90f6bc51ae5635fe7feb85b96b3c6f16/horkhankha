        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form role="form" method="post" onsubmit="return check();"
                    action="index.php?content=services&action=edit" enctype="multipart/form-data">
                    <input type="hidden" id="services_id" name="services_id"
                        value="<?php echo $services['services_id']; ?>" />
                    <input type="hidden" id="services_img_o" name="services_img_o"
                        value="<?php echo  $services['services_img'] ;?>" />
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="services_name_th" name="services_name_th" class="form-control"
                                    value="<?php echo $services['services_name_th'];?>">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="services_name_en" name="services_name_en" class="form-control"
                                    value="<?php echo $services['services_name_en'];?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>รูป</label>
                                <img id="img_services_img"
                                    src="../img_upload/services/<?php echo $services['services_img']; ?>"
                                    class="img-fluid shadows hoverable">
                                <input accept=".jpg , .png" type="file" id="services_img" name="services_img"
                                    class="form-control" style="" onChange="readURL(this,'services_img');">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea id="services_detail_th" name="services_detail_th" class="form-control"
                                    style="min-height: 200px;" /><?php echo $services['services_detail_th'];?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea id="services_detail_en" name="services_detail_en" class="form-control"
                                    style="min-height: 200px;" /><?php echo $services['services_detail_en'];?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div align="right">
                        <button type="button" class="btn btn-default"
                            onclick="window.location='?content=services';">ย้อนกลับ</button>
